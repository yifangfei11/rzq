...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/index.php/Admin/Role/edit/id/11.html" method="post">
            <input type="hidden" name="id" value="<?php echo $data['id'];?>"/>
            <table width="90%" id="general-table" align="center">
                <tr>
                    <td class="label">角色名称：</td>
                    <td><input type="text" name="role_name" value="<?php echo $data['role_name'];?>"size="20" /></td>
                </tr>
                <tr>
                    <td class="label">权限列表：</td>
                    <td>
                        <?php foreach($priData as $k=>$v): if(strpos(','.$rpData['pri_id'].',',','.$v['id'].',') !== FALSE) $check = 'checked="checked"'; else $check = ''; ?>
