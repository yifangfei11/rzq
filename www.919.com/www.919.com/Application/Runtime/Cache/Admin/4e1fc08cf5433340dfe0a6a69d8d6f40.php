...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/index.php/Admin/Brand/edit/id/3.html" method="post">
            <input type="hidden" name="id" value="<?php echo $data['id'];?>"/>
            <table width="90%" id="general-table" align="center">
                <tr>
                    <td class="label">品牌名称：</td>
                    <td><input type="text" name="brand_name" value="<?php echo $data['brand_name'];?>"size="30" />
                ...
                <tr>
                    ...
                    <td><input type="text" name="site_url" value="<?php echo $data['site_url'];?>"size="20" />
                </tr>
            </table>
