						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									...
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">
	    							<img src="/Public/Home/images/preview_s3.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m4.jpg',largeimage: 'images/preview_l4.jpg'}">
	    							<img src="/Public/Home/images/preview_s4.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m5.jpg',largeimage: 'images/preview_l5.jpg'}">
	    							<img src="/Public/Home/images/preview_s5.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m6.jpg',largeimage: 'images/preview_l6.jpg'}">
	    							<img src="/Public/Home/images/preview_s6.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m7.jpg',largeimage: 'images/preview_l7.jpg'}">
	    							<img src="/Public/Home/images/preview_s7.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m8.jpg',largeimage: 'images/preview_l8.jpg'}">
	    							<img src="/Public/Home/images/preview_s8.jpg"></a>
								</li>
								<li>
									<a href="javascript:void(0);" 
									rel="{gallery: 'gal1', smallimage: '/Public/Home/images/preview_m9.jpg',largeimage: 'images/preview_l9.jpg'}">
