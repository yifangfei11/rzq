...
/**
 * @fileOverview 让内部各个部件的代码可以用[amd](https://github.com/amd__PUBLIC__/Home/Js/amdjs-api/wiki/AMD)模块定义方式组织起来。
 *
...
(function( root, factory ) {
    var modules = {},
        ...
        // 内部require, 简单不完全实现。
        // https://github.com/amd__PUBLIC__/Home/Js/amdjs-api/wiki/require
     ...
     *
     * As you know, Web Uploader的每个文件都是用过[AMD](https://github.com/amd__PUBLIC__/Home/Js/amdjs-api/wiki/AMD)规范中的`define`组织起来的, 每个Module都会有个module id.
