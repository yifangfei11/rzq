...
class  GoodsModel extends Model{
    //添加控制字段
  protected $insertFields='goods_name,shop_price,market_price,is_on_sale,goods_desc,logo,sm_logo,mid_logo,big_logo,mbig_logo,brand_id,brand_name,cat_id,type_id';
  protected $updateFields='id,goods_name,shop_price,market_price,is_on_sale,goods_desc,logo,sm_logo,mid_logo,big_logo,mbig_logo,brand_id,brand_name,cat_id,type_id';
    //自动提示验证
