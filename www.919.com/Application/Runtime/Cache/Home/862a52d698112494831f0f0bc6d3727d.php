		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="/Public/Uploads/<?php echo $viewPath . $info['mbig_logo']; ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo $viewPath.$v['mid_logo']; ?>',largeimage: '<?php echo $viewPath.$v['big_logo']; ?>'}"><?php showImage($v['sm_logo']); ?></a>
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
