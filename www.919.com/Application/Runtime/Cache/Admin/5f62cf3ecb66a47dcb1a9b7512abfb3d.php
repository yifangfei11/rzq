...
<div id="main-div">
    <div id="menu-list">
        <ul id="menu-ul">
            ...
            会员管理
                <ul>
                    <li class="menu-item"><a href="<?php echo U('MemberLevel/lst') ?>" target="main-frame">会员列表</a></li>
                    <li class="menu-item"><a href="<?php echo U('MemberLevel/add') ?>" target="main-frame">添加会员</a></li>
...
<script language="JavaScript">
    ...
    function toggleCollapse() {
        ...
        collapse = !collapse;
        document.getElementById('toggleImg').src = collapse ? '/Public/Admin/Image/menu_minus.gif' : '/Public/Admin/Image/menu_plus.gif';
