...
<div class="tab-div">
    ...
    <div id="tabbody-div">
        <form enctype="multipart/form-data" action="/index.php/Admin/Type/edit/id/1.html" method="post">
            <input type="hidden" name="id" value="<?php echo $data['id'];?>"/>
            <table width="90%" id="general-table" align="center">
                <tr>
                    <td class="label">类型名称：</td>
                    <td><input type="text" name="type_name" value="<?php echo $data['type_name'];?>"size="30" />
